...
class YesOrNoQuestions extends StatefulWidget {
  @override
  State<YesOrNoQuestions> createState() => _YesOrNoQuestionsState();
}

class _YesOrNoQuestionsState extends State<YesOrNoQuestions> {
  TextEditingController description = TextEditingController();
  bool trueSelected = false;
  bool falseSelected = false;
  bool selectionMade = false;
  AssetImage? trueGifLike;
  AssetImage? falseGifUnlike;
  ...
  @override
  void initState() {
    trueGifLike = AssetImage('assets/selected_true_like.gif');
    falseGifUnlike = AssetImage('assets/selected_true_unlike.gif');
                                        ...
                                        GestureDetector(
                                          ...
                                          child: falseSelected
                                              ? Image(
                                                  height: screenWidth * 23,
                                                  width: screenWidth * 23,
                                                  image: falseGifUnlike!,
                                                  gaplessPlayback: true,
                                                )
                                              : Image.asset(
                                                  'assets/unselected_unlike.gif',
                                                  height: screenWidth * 23,
                                                  width: screenWidth * 23),
                                        ),
                                      ],
