...
class ChooseCorrectOption extends StatefulWidget {
  @override
  State<ChooseCorrectOption> createState() => _ChooseCorrectOptionState();
}

class _ChooseCorrectOptionState extends State<ChooseCorrectOption> {
  ...
  List<dynamic> sampleOptionsList = [
    {
      'content': 'Bonn',
      'selected': false,
    },
                      ...
                      child: Column(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text(
                                'Which cities belong to Germany?',
                                style: TextStyle(
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    for (int i = 0;
                                        i < sampleOptionsList.length;
                                        i++)
                                      GestureDetector(
                                        onTap: () {
                                          setState(() {
                                            sampleOptionsList[i]['selected'] =
                                                !sampleOptionsList[i]
                                                    ['selected'];
                                          });
                                        },
                                                      ...
                                                      border: Border.all(
                                                          color: !isOptionChecked &&
                                                                  sampleOptionsList[i]
                                                                      ['selected']
                                                              ? theme.darkTextColor
                                                              : isOptionChecked && sampleOptionsList[i]['selected'] && sampleOptionsList[i]['content'] != 'Rom'
                                                                  ? Colors.green
                                                                  : isOptionChecked && sampleOptionsList[i]['content'] == 'Rom'
                                                                      ? Colors.red.shade500
                                                                      : theme.lightTextColor.withOpacity(.4))),
                                                  child: Row(
                                                    mainAxisAlignment:
                                                        MainAxisAlignment
                                                            .spaceBetween,
                                                    children: [
                                                      ...
                                                      Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                            ...
                                                            color: !isOptionChecked && sampleOptionsList[i]['selected']
                                                                ? theme.darkTextColor
                                                                : isOptionChecked && sampleOptionsList[i]['selected'] && sampleOptionsList[i]['content'] != 'Rom'
                                                                    ? Colors.green
                                                                    : isOptionChecked && sampleOptionsList[i]['content'] == 'Rom'
                            ...
                            children: [
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Text(
                                    isOptionChecked ? 'Weiter' : 'Überprüfen',
